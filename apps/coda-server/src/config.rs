...
/// Default plan session idle timeout in seconds (60 minutes).
const DEFAULT_SESSION_IDLE_TIMEOUT_SECS: u64 = 3600;

/// Default session reaper interval in seconds (5 minutes).
...
pub struct ServerConfig {
    ...
    /// Maximum idle time (in seconds) before a plan session is reaped.
...
"#,
    ...
    fn test_should_round_trip_yaml() {
        ...
        assert_eq!(deserialized.session_idle_timeout_secs, 1800);
        assert_eq!(deserialized.reaper_interval_secs, 120);
    }

    #[test]
    fn test_should_use_default_session_timeout() {
        let yaml = r#"
slack:
  app_token: "xapp-1-test"
  bot_token: "xoxb-test"
"#;
    ...
    #[test]
    fn test_should_override_session_timeout() {
        let yaml = r#"
slack:
  app_token: "xapp-1-test"
  bot_token: "xoxb-test"
